      ...
      <div className="col-span-12 lg:col-span-7 flex justify-center items-center p-8 bg-gradient-to-tr from-brand-50 via-white to-brand-100">
        <div className="max-w-md w-full animate-fade-in flex flex-col items-center">
          {showOnboarding && activeUser ? (
            <div className="w-full glass-card p-8 border border-gray-200/50 shadow-xl rounded-2xl relative bg-white">
              <button
                onClick={() => {
              ...
              <div className="text-center mb-6 mt-4">
                ...
                <p className="text-gray-500 text-xs mt-1">
                  Welcome, <span className="font-semibold text-brand-700">{activeUser.fullName || 'User'}</span>! Please create a workspace to complete your registration.
                </p>
              </div>

              {errorMsg && (
                <div className="bg-red-50 text-red-700 border-l-4 border-red-500 p-3 rounded-r-lg mb-4 text-xs flex flex-col gap-2">
                  <span>{errorMsg}</span>
                  <button
                    onClick={() => setErrorMsg('')}
